...
export default function WhatspilotPage() {
  ...
  const fetchBlogs = async () => {
    try {
      const res = await fetch('/api/blogs?platform=whatspilot');
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Whatspilot Blogs</h1>
          <p className="text-gray-500 mt-1">Manage your Whatspilot content</p>
        </div>
        <Link
          href="/whatspilot/new"
